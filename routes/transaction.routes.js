...
import {  getTransactions, imageUpload, updateProfit, upload } from '../controllers/transaction.controllers.js';
...
router.post('/image-Upload', upload.single('image'), validateUsers, imageUpload);
